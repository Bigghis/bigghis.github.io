...
Per un approfondimento sulle metriche di classificazione (Confusion Matrix, Precision, Recall, F1-score, Accuracy, ROC e AUC), si rimanda al post dedicato: [Classificazione](/posts/CLASSIFICAZIONE/).
