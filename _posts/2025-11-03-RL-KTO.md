...
Per usare KTO con [TRL](https://github.com/huggingface/trl){:target="_blank"} si utilizza la classe [KTOTrainer](https://huggingface.co/docs/trl/v0.24.0/en/kto_trainer#trl.KTOTrainer){:target="_blank"} e KTOConfig.  
